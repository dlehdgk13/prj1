      ...
      <table border="0" cellpadding="5" cellspacing="5">
         <tr valign="top">
            <td align="right">[사업분야별]&nbsp;</td><td>
               ...
               <input type="checkbox" name="corp_business_areas" value="IT">IT &nbsp;
               <input type="checkbox" name="corp_business_areas" value="통신">통신 &nbsp;
               <input type="checkbox" name="corp_business_areas" value="금융">금융 &nbsp;
               <input type="checkbox" name="corp_business_areas" value="출판&미디어">출판&미디어&nbsp;
               <input type="checkbox" name="corp_business_areas" value="교육&학원">교육&학원 &nbsp;<br>
               <input type="checkbox" name="corp_business_areas" value="운송&물류">운송&물류 &nbsp;
               <input type="checkbox" name="corp_business_areas" value="학교">학교 &nbsp;
               <input type="checkbox" name="corp_business_areas" value="기타">기타 &nbsp;      
