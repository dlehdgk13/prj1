	...
	function empInfoUp() {
		...
		$.ajax({
			...
			success : function(result) {
				alert("수정이 완료되었습니다.");
				$("img").remove();
				location.href = "/group4erp/viewEmpContentForm.do?emp_no="
						+ emp_no;
			}
		});
			...
			<aside>
				<div id="sidebar" class="nav-collapse ">
					...
					<ul class="sidebar-menu" id="nav-accordion">
						<p class="centered">
							<a href="profile.html"><img src="${ctRootImg}/ui-sam.jpg"
								class="img-circle" width="80"></a>
						</p>
						<h5 class="centered">Sam Soffes</h5>
						<li class="mt"><a href="/group4erp/goMainTest.do"> <i
						...
						<li class="sub-menu"><a href="javascript:;"> <i
							...
							<ul class="sub">
								...
								<li><a href="/group4erp/goMyWorkTime.do"><i
										class="fa fa-list"></i>근태 조회</a></li>
						...
						<li class="sub-menu"><a class="active" href="javascript:;"> <i
							...
							<ul class="sub">
								<li><a href="/group4erp/viewEmpList.do"><i
										class="fa fa-info-circle"></i>직원정보</a></li>
								<li><a href="/group4erp/viewSalList.do"><i
										class="fa fa-file"></i>급여명세서 조회</a></li>
								<li><a href="/group4erp/viewEmpWorkStateList.do"><i
										class="fa fa-list"></i>직원별 근무현황</a></li>
				...
				<section class="wrapper" style="text-align: left;">
					<table border=0 cellpadding=0 cellspace=0 width="98%">
						<tr>
							<td>
								<h3 align=left>
									<i class="fa fa-angle-right"></i>직원 상세보기
								</h3>
							<td>
								<h3 align=right>
                  ...
                  <div class="col-lg-12">
                     <div class="content-panel"> -->
							...
							<form name="empContentUp" class="form-horizontal style-form"
								method="post" enctype="multipart/form-data">

								<table class="empContentInfo tab" width="100%" border=1
									bordercolor="white" cellpadding=5 align=center>
									<tr>
                                       ...
                                       <c:otherwise>
                                    ...
                                    </c:choose> <%-- <img src="${ctRootImage}/emp_0003.jpg" width="100%" height="150"> --%>
										...
										<td width="7%">∗ 영어명</td>
										<td width="33%"><input type="text" size="27"
											name="emp_eng_name" value="${employeeInfoUpDTO.emp_eng_name}"></td>
									</tr>
									<tr>
										<td>∗ 사번</td>
									...
									<tr>
                                       ...
                                       <input type="radio"
													name="emp_gender" value="남">남
                                    </c:if> <c:if
												test="${employeeInfoUpDTO.emp_gender=='남'}">
												<input type="radio" name="emp_gender" value="여">여
                                       <input type="radio"
													name="emp_gender" value="남" checked>남
                                    </c:if></td>
									...
									<tr>
										<td colspan="7">
											<div class="fileBox" align="left">
												...
												<input align="left" type="text" class="fileName"
													placeholder="증명사진 업로드" readonly="readonly"> <label
													style="cursor: pointer" for="uploadBtn" class="btn_file"
													align="left"> <img
													src="/group4erp/resources/image/upload (1).png"
													align="center" width="75%" height="5%">
                  ...
                  <div class="col-lg-12">
                     <div class="content-panel"> -->
							...
							<table table class="empContentInfo tab" width="100%" border=1
								...
								<tr>
									...
									<td width="8%">∗ 채용형태</td>
									<td colspan="2" width='40%'><select name="worktime_name">
								...
								<tr>
									...
									<td>∗ 연봉</td>
									<td colspan="2"><input type="text" name="salary" size="27"
										value="${employeeInfoUpDTO.salary}"></td>
								</tr>
								<tr>
									<td>∗ 입사일</td>
									...
									<td colspan="2"><input type="text" name="resign_date"
										size="27" id="resign_date"
										value="${employeeInfoUpDTO.resign_date}"></td>
								</tr>
								<tr>
									<td>∗ 휴직상태</td>
									<td colspan="2"><c:if
											test="${employeeInfoUpDTO.is_on_leave=='F'}">
											<font style='color: blue'>재직중</font>
										</c:if> <c:if test="${employeeInfoUpDTO.is_on_leave=='T'}">
