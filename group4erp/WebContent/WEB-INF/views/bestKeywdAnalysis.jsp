    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <div class="content-panel">
          <div align="left"><h4><i class="fa fa-angle-right"></i>  키워드 검색 분석</h4></div>
          [상위순]&nbsp; <input type="checkbox" name="rank" class="rank" value="10">Best 10 &nbsp;
            <input type="checkbox" name="rank" class="rank" value="15">Best 15 &nbsp;
            <input type="checkbox" name="rank" class="rank" value="20">Best 20 &nbsp;
                <input type="hidden" name="selectPageNo">
          <div class="panel-body">
            ...
            <tr>
               ...
               <td valign="top" width='25%'>
                  ...
                  <table class="bestKeywdTable table table-bordered table-striped table-condensed" name="bestKeywdTable tab" cellpadding="5" cellspacing="5" width="70%" align="left">
                     
                     <tr><th width="10%" style="cursor:pointer; text-align:center;"><b>순위</b></th><th width="10%" style="cursor:pointer; text-align:center;"><b>키워드</b></th><th width="10%" style="cursor:pointer; text-align:center;"><b>검색 횟수</b></th></tr>
                        <c:forEach items='${bestKwdDTOList}' var="bestKwdDTOList" varStatus="loopTagStatus">
                           <tr onClick="viewKwdDailyCnt('${bestKwdDTOList.srch_kwd}');">
                              <td align="center">${bestKwdDTOList.rank}</td>
                              <td align="center">${bestKwdDTOList.srch_kwd}</td>
